...
Rather than being curated by genre, the playlist reflects long-term listening behaviour, making it suitable for analysing whether perceived diversity aligns with measurable structural consistency.
...
- Spotify audio features approximate perceptual qualities (energy, valence, etc.)
- Personal taste can be quantified through repeated listening patterns
- Genre labels are less informative than audio features
...
### Week 12 – Hierarchical Clustering of the Corpus

![Ward’s method clustering](week12_hierarchical_clustering_dendrogram.png)
